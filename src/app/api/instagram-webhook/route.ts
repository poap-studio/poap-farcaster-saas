...
import { processInstagramMessage } from '~/lib/instagram-message-processor';
              ...
              try {
                ...
                if (messageData.storyId) {
                  ...
                  if (drop) {
                    ...
                    const result = await processInstagramMessage(savedMessage, drop);
                    
                    if (result.processed) {
                      console.log('[Instagram Webhook] Message processed successfully:', result);
                    } else {
                      console.error('[Instagram Webhook] Failed to process message:', result.error);
                    }
                  } else {
